...
Rev 0.72 2015/01/27
ISO Layers ported from libiec61850 thanks to Michael Zillgith.
ISO Parameters dialog - settings per IED. Settings persistence to ieds.ini file.
Not fully tested yet.
Minor debugs to SCL view.
